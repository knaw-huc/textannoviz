...
export function SearchForm(
  ...
  React.useEffect(() => {
    ...
    if (!isEmpty(keywordFacets)) {
      const searchQueryTerms = Object.keys(propSearchQuery.terms);
      ...
      const initialFilteredAggs = keywordFacets.reduce<string[]>(
  ...
  function facetFilterChangeHandler(keys: Selection) {
    ...
    const orderedFilteredAggs = keywordFacets
      .map((facet) => facet[0])
    ...
    <div className={containerClasses}>
      ...
      >
        ...
        <TabPanel id="search" className={tabPanelStyling}>
          ...
          {projectConfig.showKeywordFacets &&
            ...
            filteredAggs.map((facetName, index) => {
              const facetValue = keywordFacets.find(
        ...
        <TabPanel id="settings" className={tabPanelStyling}>
          ...
          {projectConfig.showFacetFilter && keywordFacets.length !== 0 && (
            <div
              role="group"
            ...
            >
              ...
              <FacetFilter
                allPossibleKeywordFacets={keywordFacets}
