...
export function ShowLessButton(props: ShowLessButtonProps) {
  ...
  return (
    <Button
      className="text-brand2-700 fill-brand2-700 hover:fill-brand2-800 hover:text-brand2-800 border-brand2-100 bg-brand2-50 -mt-10 flex h-10 w-full max-w-[450px] items-center justify-end border-t-2 pr-2 outline-none"
