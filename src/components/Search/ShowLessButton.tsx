...
export function ShowLessButton(props: ShowLessButtonProps) {
  ...
  return (
    <Button
      className="hover:bg-brand2-50 fill-brand2-500 hover:fill-brand2-700 border-brand2-100 bg-brand2-50 -mt-6 flex h-10 w-full max-w-[450px] items-center justify-end border-t-2 pr-2 text-black outline-none hover:text-black"
