    ...
    <SearchField {...props} className="group flex min-w-[40px] flex-col gap-1">
      ...
      <Group className="group flex h-10 items-center overflow-hidden rounded-md border border-neutral-500 focus-within:border-black">
        ...
        <Input
          ...
          className="min-w-0 flex-1 border-neutral-400 bg-white px-2 py-1.5  text-gray-800 placeholder:italic placeholder:text-neutral-500 [&::-webkit-search-cancel-button]:hidden"
        />
