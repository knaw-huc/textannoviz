...
export const Header = () => {
  ...
  const letterNumber = letterAnnoBody?.n;
  ...
  return (
    <header className="grid grid-cols-[auto_auto_50px] grid-rows-[auto_auto] bg-[#DACC98] sm:grid-cols-[auto_auto_110px_50px] lg:grid-cols-[auto_auto_110px]">
      ...
      <div className="col-span-2 flex items-center justify-end  px-4 sm:col-span-3 lg:col-span-1">
        <Button
