...
export const SearchInfoPage = () => {
  ...
  return (
    <div className="border-brand1Grey-100 -mx-6 -mb-10 flex -translate-y-16 border-b bg-[#56BDDA] px-6 py-8 text-black lg:-mx-10 lg:px-10">
      <div className="mx-auto w-full max-w-4xl">
        ...
        <div className="my-8 flex max-w-3xl items-start justify-between md:items-end">
          ...
          {/* Button */}
          <Button
            className="rounded border border-black bg-[#DACC98] p-2 text-black outline-none"
